...
%>
<script src="/etc/clientlibs/rachelcruze/js/ckeditor/ckeditor.js"></script>
<textarea style="display: none;" <%= attrs.build() %>><%= vm.get("value", String.class) %></textarea>
<script>
    window.setTimeout(function() {
        CKEDITOR.replace('<%= cfg.get("name", String.class) %>');
    }, 200);
</script>